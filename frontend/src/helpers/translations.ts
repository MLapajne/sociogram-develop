  ...
  switch (language) {
    case "sl":
      return {
        ...
        confirmationPrompt:
          "Natančno preglejte svoje odgovore in potrdite izbiro.",
        confirmText: "Potrdi",
        submitButtonText: "Pošlji",
        cancelText: "Prekliči",
        disclaimerTitle: "Dobrodošli v anketi za Sociogram!",
        ...
        answerText:
          "Odgovorite na naslednja vprašanja. Za vsako izberite eno osebo. Pred oddajo preglejte svoje odgovore, saj po tem spreminjanje ni več možno.",
    ...
    case "hr":
      return {
        ...
        confirmationPrompt:
          "Pažljivo pregledajte svoje odgovore i potvrdite svoj odabir.",
        confirmText: "Potvrdi",
        ...
        welcomeText: "Dobrodošli",
        answerText:
          "Odgovorite na sljedeća pitanja, odaberite jednu osobu za svako. Prije slanja, pregledajte svoje odgovore jer ih nakon toga ne možete mijenjati.",
    ...
    case "de":
      return {
        ...
        confirmationPrompt:
          "Überprüfen Sie Ihre Antworten sorgfältig und bestätigen Sie Ihre Auswahl.",
        confirmText: "Bestätigen",
        submitButtonText: "Senden",
        cancelText: "Abbrechen",
        disclaimerTitle: "Willkommen im Formular für Sociogram!",
        ...
        answerText:
          "Beantworten Sie die folgenden Fragen und wählen Sie für jede eine Person aus. Überprüfen Sie Ihre Antworten sorgfältig, bevor Sie sie absenden, da Änderungen danach nicht mehr möglich sind.",
    ...
    default:
      return {
        ...
        confirmationPrompt:
          "Carefully review your answers and confirm your selection.",
        confirmText: "Confirm",
        submitButtonText: "Submit",
        cancelText: "Cancel",
        disclaimerTitle: "Welcome to the form for Sociogram!",
        ...
        welcomeText: "Welcome",
        answerText:
          "Answer the following questions, choosing one person for each. Before submitting, review your answers as changes cannot be made afterwards.",
