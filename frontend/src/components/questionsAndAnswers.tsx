      ...
      if (questionType === "pos") {
        if (!posQuestions.includes(userId)) {
          let line =
            "pos:" +
            " " +
            users[parseInt(userId, 10) - 1].firstName +
            " " +
            users[parseInt(userId, 10) - 1].lastName +
            "\n";
          dialogPrompt = dialogPrompt.concat(line);
  ...
  return (
    <>
      ...
      <ConfirmationDialog
        ...
        title={translations.confirmationPrompt}
